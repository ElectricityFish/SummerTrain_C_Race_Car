...
#define MOTOR1_PWM_PIN                     (TIM5_PWM_CH2_A1)
#define MOTOR1_DIR_PIN                     (A0)
#define MOTOR2_PWM_PIN                     (TIM5_PWM_CH4_A3)
#define MOTOR2_DIR_PIN                     (A2)

//正占空比时方向引脚的电平。若实车测试某一路反向，只修改对应宏即可。
#define MOTOR1_POSITIVE_DIR_LEVEL          (GPIO_HIGH)
#define MOTOR2_POSITIVE_DIR_LEVEL          (GPIO_HIGH)
